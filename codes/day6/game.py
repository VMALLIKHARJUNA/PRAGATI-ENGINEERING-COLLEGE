#Write a program that has a class named Circle use a class variable to define the values of constant pi.Use this class variable to calculate area and circumference of a circle with specified radius where radius =7.5.
